...
export default function Stats({ stats }: { stats: Stat[] }) {
  return (
    <section className="border-b border-gray-300 px-6 py-16" aria-label="Product platform figures">
      <dl className="mx-auto grid max-w-7xl grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <div key={stat.label} className="rounded-2xl border border-gray-300 bg-white p-7">
