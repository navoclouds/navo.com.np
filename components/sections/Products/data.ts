...
export const productsContent: ProductsContent = {
  hero: {
    ...
    bullets: ["Self-hosted or cloud", "Open REST & GraphQL APIs", "SOC 2 aligned"],
    actions: [
  ...
  stats: [
    { value: "1.4B", label: "Events processed monthly", caption: "Across all production tenants." },
    { value: "42ms", label: "Median API response", caption: "p50 measured at the edge." },
    { value: "99.98%", label: "Rolling 12-month uptime", caption: "Independently monitored." },
    { value: "38", label: "Enterprise deployments", caption: "In 11 countries." },
  ],
  ...
  products: [
    {
      ...
      summary:
        "An advanced workflow orchestration platform that automates complex, multi-stage operational processes across distributed teams. Built for high-throughput environments requiring strict compliance and auditability.",
      features: [
        "Visual DAG builder for process definition.",
        "Real-time state monitoring and analytics.",
        "Enterprise-grade RBAC and compliance logging.",
        "Retry, backoff and dead-letter handling built in.",
      ],
      metrics: [
        { value: "120k", label: "Workflow runs per day" },
        { value: "-61%", label: "Manual handoffs removed" },
        { value: "4 min", label: "Median time to recover" },
      ],
      tech: ["TypeScript", "Temporal", "PostgreSQL", "Kubernetes", "OpenTelemetry"],
      image: "",
      imageAlt: "FlowDesk orchestration dashboard showing a node graph of a multi-stage process",
      cta: { label: "Explore FlowDesk", href: "/contact?product=flowdesk" },
    },
    {
      id: "insightai",
      name: "InsightAI",
      ...
      image: "",
      imageAlt: "InsightAI analytics dashboard with area charts and anomaly markers",
    ...
    },
    {
      ...
      image: "",
      imageAlt: "PayGrid payments network visualisation with interconnected routing nodes",
  ...
  comparison: {
    ...
    rows: [
      { feature: "Availability", values: ["General availability", "General availability", "Private beta"] },
      { feature: "Self-hosted deployment", values: ["Yes", "Yes", "—"] },
      { feature: "SSO / SCIM provisioning", values: ["Yes", "Yes", "Yes"] },
      { feature: "Audit log retention", values: ["7 years", "3 years", "10 years"] },
      { feature: "Public API", values: ["REST + GraphQL", "REST", "REST + gRPC"] },
      { feature: "Data residency", values: ["EU, US, APAC", "EU, US", "EU, US"] },
  ...
  faq: [
    {
      ...
      answer:
        "Yes. FlowDesk and InsightAI ship as Helm charts and Terraform modules that deploy into your own VPC on AWS, GCP or Azure. You keep the data plane; we operate the control plane only if you want us to.",
    },
    {
      question: "How does pricing work?",
      answer:
        "Pricing is a base per workspace plus a usage component — workflow runs for FlowDesk, rows scanned for InsightAI. There is no per-seat fee, so adding viewers or auditors costs nothing.",
    },
    {
