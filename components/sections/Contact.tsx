      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 px-4 sm:px-6 text-slate-600 md:flex-row md:gap-12 lg:px-8">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-600">
            Tell us what you&rsquo;re trying to solve. We&rsquo;ll help you figure out the right technology.
          </p>
        </div>

        <div className="shrink-0">
          <Link href="/contact" aria-label="Contact us">
            <button className="flex h-16 w-16 items-center justify-center rounded-full bg-[#c9449e] text-white transition-transform duration-200 hover:scale-105 active:scale-95 sm:h-20 sm:w-20 lg:h-24 lg:w-24">
